...
public class XmlManager {
    ...
    private static final String FERIBOT_FILE =
            DATA_DIR + "feribotlar.xml";

    private static final String ARAC_FILE =
            DATA_DIR + "araclar.xml";
    ...
    public static List<Feribot> feribotlariOku() {
        ...
        try {
            ...
            NodeList nodeList =
                    doc.getElementsByTagName("feribot");
    ...
    public static void tumAraclariKaydet(
        ...
        try {
            ...
            for (Arac arac : araclar) {
                ...
                if (plakalar.contains(arac.getPlaka())) {
                    continue;
                }

                plakalar.add(arac.getPlaka());

                Element aracElem =
                        doc.createElement("arac");
    ...
    private static void createDefaultAracXml() {
        ...
        try {
            ...
            List<Arac> varsayilan =
                    new ArrayList<>();

            varsayilan.add(
                    new Arac("",0,"34ABC01",9.30,1)
            );

            varsayilan.add(
                    new Arac("",0,"34ABC02",9.35,2)
            );

            varsayilan.add(
                    new Arac("",0,"34ABC03",9.40,2)
            );

            varsayilan.add(
                    new Arac("",0,"34ABC04",9.45,1)
            );

            varsayilan.add(
                    new Arac("",0,"34ABC05",10.00,2)
            );

            varsayilan.add(
                    new Arac("",0,"34ABC06",10.05,2)
            );

            varsayilan.add(
                    new Arac("",0,"34ABC07",10.10,1)
            );

            varsayilan.add(
                    new Arac("",0,"34ABC08",10.15,2)
            );
